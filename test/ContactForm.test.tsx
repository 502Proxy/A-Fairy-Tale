...
describe('ContactForm Component', () => {
    ...
    it('should render the contact form with input fields and submit button', () => {
        ...
        expect(screen.getByRole('heading', { name: /Schreib uns/i })).toBeInTheDocument();
    });
    ...
    it('should handle successful form submission', async () => {
        ...
        expect(screen.queryByText(/Danke für deine Nachricht!/i)).not.toBeInTheDocument();
    ...
    it('should display an error message if submission fails', async () => {
        ...
        console.warn("[Test Info] Error path test requires modification or mocking to force failure.");
